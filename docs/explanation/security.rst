.. meta::
   :description: Understand the security design, risks, and best practices for the MariaDB K8s Operator charm.
...
.. TODO: Remember to update this file for your charm!!
         ...
         sentence like:
         For details regarding upstream MariaDB K8s Operator configuration and broader security
...
This document outlines the security design of the MariaDB K8s Operator  charm along common risks
and best practices.

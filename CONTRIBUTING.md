<!-- Remember to update this file for your charm -- replace mariadb-k8s-operator with the appropriate name. -->

# Contributing

This document explains the processes and practices recommended for contributing enhancements to the mariadb-k8s-operator charm.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/mariadb-k8s-operator/issues) explaining your use case.
...
adding an entry to the [CHANGELOG.md](https://github.com/canonical/mariadb-k8s-operator/blob/main/docs/changelog.rst) file. Use the date of the
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/mariadb-k8s-operator)
...
Canonical welcomes contributions to the MariaDB K8s Operator charm. Please check out our
...
```
git clone https://github.com/canonical/mariadb-k8s-operator
```
...
OCI image for the mariadb-k8s-operator app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./mariadb-k8s-operator.charm 
```
